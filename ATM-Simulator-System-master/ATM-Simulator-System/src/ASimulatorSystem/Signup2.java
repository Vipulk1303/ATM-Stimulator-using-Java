...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        l12.setBounds(650,10,170,30);
        add(l12);

        l13.setBounds(710,10,170,30);
        add(l13);

        l1.setBounds(290,40,600,30);
        add(l1);

        l2.setBounds(100,110,100,20);
        add(l2);

        c1.setBounds(350,110,320,20);
        add(c1);

        l3.setBounds(100,140,200,20);
        add(l3);

        c2.setBounds(350,140,320,20);
        add(c2);

        l4.setBounds(100,170,200,20);
        add(l4);

        c3.setBounds(350,170,320,20);
        add(c3);

        l5.setBounds(100,220,150,20);
        add(l5);

        c4.setBounds(350,220,320,20);
        add(c4);

        l11.setBounds(100,260,150,20);
        add(l11);

        l6.setBounds(100,300,150,20);
        add(l6);

        c5.setBounds(350,300,320,20);
        add(c5);

        l7.setBounds(100,340,150,20);
        add(l7);

        t1.setBounds(350,340,320,20);
        add(t1);

        l8.setBounds(100,380,180,20);
        add(l8);

        t2.setBounds(350,380,320,20);
        add(t2);

        l9.setBounds(100,420,150,20);
        add(l9);

        r1.setBounds(350,420,100,20);
        add(r1);

        r2.setBounds(460,420,100,20);
        add(r2);

        l10.setBounds(100,460,180,20);
        add(l10);

        r3.setBounds(350,460,100,20);
        add(r3);

        r4.setBounds(460,460,100,20);
        add(r4);

        b.setBounds(570,510,100,30);
        add(b);
